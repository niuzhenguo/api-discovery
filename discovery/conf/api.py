...
opts = [
    cfg.HostAddressOpt('host_ip',
                       default='0.0.0.0',
                       help=_('The IP address on which api-discovery listens.')),
    cfg.PortOpt('port',
                default=6688,
                help=_('The TCP port on which api-discovery listens.')),
    ...
    cfg.StrOpt('public_endpoint',
               help=_("Public URL to use when building the links to the API "
                      "resources (for example, \"https://api.rocks:6688\")."
    ...
    cfg.IntOpt('api_workers',
               help=_('Number of workers for API Discovery service. '
...
opt_group = cfg.OptGroup(name='api',
                         title='Options for the api-discovery service')
